...
public class ChoixDuNombreDeTondeuses extends JFrame implements ActionListener {

	private ChoixDuNombreDeTondeusesPanneauAxivIt container = new ChoixDuNombreDeTondeusesPanneauAxivIt();

	private URL url = ChoixDuNombreDeTondeuses.class.getResource("/boutonConfirmerNbreTondeuses.png");
	...
	static int nombreDeTondeuses;

	public ChoixDuNombreDeTondeuses() {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (arg0.getSource() == boutonConfirmer) {
			...
			validation = AutonomousCar.validationNombreDeTondeusesString(jtfNbre.getText());

			if (validation == true) {

				nombreDeTondeuses = Integer.parseInt(jtfNbre.getText().trim());

				this.setVisible(false);

				new FormulaireTondeuses(1, nombreDeTondeuses); // Affichage du
																// 1er
																// formulaire
